...
class MenuItems extends StatelessWidget {
  ...
  const MenuItems({
    ...
    this.hasImageColor = false,
    this.imageColor=MyColor.colorBlack,
    this.textStyle,
  });
            ...
            Row(
              children: [
                Container(
                  ...
                  child: isSvgImage ? CustomSvgPicture(image: imageSrc, color: imageColor??MyColor.colorBlack, height: 17.5, width: 17.5) : Image.asset(imageSrc, color: MyColor.colorBlack, height: 17.5, width: 17.5),
                ),
                const SizedBox(width: Dimensions.space15),
                Text(label.tr, style: textStyle ?? regularDefault.copyWith(color: MyColor.colorBlack))
              ],
            ),
            Container(
              height: 30,
