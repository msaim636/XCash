...
import 'package:xcash_app/view/components/packages/signin_with_linkdin/signin_with_linkedin.dart';
...
class SocialLoginController extends GetxController {
  ...
  Future<void> signInWithGoogle() async {
    try {
      ...
      // print("this is google access token${googleUser?.authentication ?? ""}");
      if (googleUser == null) {
      ...
      // print("this is google access token${googleAuth.accessToken ?? ""}");
